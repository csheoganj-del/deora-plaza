...
INSERT INTO system_settings (key, value, description, category, is_public) VALUES
    ('app_name', '"DEORA Plaza"', 'Application name', 'general', true),
    ('app_version', '"1.0.0"', 'Application version', 'general', true),
    ('default_currency', '"INR"', 'Default currency', 'financial', true),
    ('currency_symbol', '"₹"', 'Currency symbol', 'financial', true),
    ('default_gst_rate', '18', 'Default GST rate percentage', 'financial', false),
    ('enable_audit_logging', 'true', 'Enable comprehensive audit logging', 'security', false),
    ('session_timeout_minutes', '1440', 'Session timeout in minutes (24 hours)', 'security', false),
...
-- Insert default GST configurations for each business unit
INSERT INTO gst_config (business_unit, cgst_rate, sgst_rate, total_gst_rate, is_active) VALUES
    ('cafe', 9.00, 9.00, 18.00, true),
    ('bar', 9.00, 9.00, 18.00, true),
    ('hotel', 9.00, 9.00, 18.00, true),
    ('garden', 9.00, 9.00, 18.00, true)
