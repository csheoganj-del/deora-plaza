...
export function HotelDashboard() {
  ...
  const loadHotelMetrics = () => {
    ...
    // Mock data for hotel metrics
    const mockMetrics: HotelMetrics = {
      dailyRevenue: 12580.00,
      occupiedRooms: 42,
      totalRooms: 60,
      occupancyRate: 70.0,
      checkInsToday: 8,
      ...
      reservations: 15,
      upcomingCheckIns: [
        { time: "2:00 PM", guest: "John Smith", room: "301" },
        { time: "3:00 PM", guest: "Sarah Johnson", room: "215" },
        { time: "4:00 PM", guest: "Mike Davis", room: "412" },
        { time: "5:00 PM", guest: "Emily Brown", room: "108" },
        { time: "6:00 PM", guest: "Robert Wilson", room: "305" }
      ]
    };
