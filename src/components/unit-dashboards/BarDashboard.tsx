...
export function BarDashboard() {
  ...
  const loadBarMetrics = () => {
    ...
    // Mock data for bar metrics
    const mockMetrics: BarMetrics = {
      dailyRevenue: 5230.25,
      ordersToday: 89,
      activeCustomers: 32,
      popularDrinks: [
        { name: "Craft Beer", count: 24, revenue: 144.00 },
        { name: "Mojito", count: 18, revenue: 270.00 },
        { name: "Whiskey Sour", count: 15, revenue: 225.00 },
        { name: "Wine Glass", count: 12, revenue: 180.00 },
        { name: "Old Fashioned", count: 10, revenue: 200.00 }
      ],
      staffOnDuty: 3,
      inventoryAlerts: 5,
      averageOrderValue: 58.76,
      peakHours: [
        { hour: "6:00 PM", orders: 8 },
        { hour: "7:00 PM", orders: 15 },
        { hour: "8:00 PM", orders: 22 },
        { hour: "9:00 PM", orders: 18 },
        { hour: "10:00 PM", orders: 14 },
        { hour: "11:00 PM", orders: 12 }
      ],
      tabCount: 45,
      openTabs: 18
    };
