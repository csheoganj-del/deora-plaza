            ...
            <div className="flex-1 overflow-y-auto pr-2">
                <div className="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3"> {/* Updated to responsive grid with more columns */}
                    {filteredItems.map((item) => {
                        ...
                        return (
                            <div className="premium-card flex items-center justify-between p-3 rounded-lg shadow-sm transition-all hover:shadow-md hover:border-[var(--rajasthani-teal-light)] active:scale-98"
                            >
