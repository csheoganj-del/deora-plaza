    ...
    <footer className="bg-slate-950 text-[#9CA3AF] pt-24 pb-12 border-t border-[#111827]">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              <Image src="/assets/logo-bloom.svg" alt="Bloom Cafe & Restaurant" width={140} height={50} className="h-14 w-auto brightness-0 invert" />
              <span className="text-2xl font-bold tracking-tight text-white">Bloom Cafe & Restaurant</span>
            </div>
        ...
        <div className="pt-8 border-t border-[#111827] flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="text-[#9CA3AF] text-sm">© {new Date().getFullYear()} Bloom Cafe & Restaurant. All rights reserved.</div>
