        ...
        <div className="vision-sidebar">
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h1 className="text-lg font-semibold" style={{ color: 'var(--text-color)' }}>Bloom Cafe</h1>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p style={{ color: 'var(--text-color)', opacity: 0.7 }}>Welcome back to your Bloom Cafe dashboard</p>
              </div>
