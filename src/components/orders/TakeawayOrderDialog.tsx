...
export function TakeawayOrderDialog({ isOpen, onClose, businessUnit }: TakeawayOrderDialogProps) {
            ...
            <div className="bg-white w-full max-w-6xl rounded-xl shadow-xl ring-1 ring-black/5">
                ...
                <div className="flex items-center justify-between px-4 py-2 border-b">
                    <div className="flex items-center gap-3">
                        <h3 className="text-lg font-semibold">New Takeaway Order ({businessUnit})</h3>
                    </div>
