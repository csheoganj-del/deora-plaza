...
interface GardenReceiptServerProps {
  booking: any;
...
export function GardenReceiptServer({
  booking,
  receiptNumber,
  paymentType,
  businessSettings,
}: GardenReceiptServerProps) {
        ...
        <div className="info-box">
          ...
          <table className="billing-table">
            ...
            <tbody>
              ...
              {advancePayment && effectivePaymentType !== "advance" && (
                <tr>
                  <td>Less: Advance Paid (Ref #{advancePayment.receiptNumber})</td>
                  <td className="text-right">-{advancePayment.amount.toLocaleString("en-IN", { minimumFractionDigits: 2 })}</td>
                </tr>
              )}
              <tr className="highlight-row">
                <td><strong>Amount Paid ({effectivePaymentType === "advance" ? "Advance" : "Final"})</strong></td>
