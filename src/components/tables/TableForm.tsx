            ...
            <DialogContent>
                ...
                <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-4 py-4">
                    <div>
                        ...
                        />
                        {errors.tableNumber && <p className="text-red-500 text-sm mt-1">{(errors.tableNumber as any)?.message}</p>}
                    </div>
                    <div>
                        ...
                        />
                        {errors.capacity && <p className="text-red-500 text-sm mt-1">{(errors.capacity as any)?.message}</p>}
                    </div>
                    <DialogFooter>
