...
export function applyAdaptiveColors(colors: BackgroundPreference['dominantColors']): void {
  ...
  const cardBg = colors.text === '#f8f8f8' 
    ? 'rgba(26, 26, 26, 0.4)' // Dark semi-transparent for light text
    : 'rgba(255, 255, 255, 0.25)'; // Light semi-transparent for dark text
    
  const cardBorder = colors.text === '#f8f8f8'
    ? 'rgba(248, 248, 248, 0.2)'
    : 'rgba(0, 0, 0, 0.15)';
    
  const inputBg = colors.text === '#f8f8f8'
    ? 'rgba(26, 26, 26, 0.3)'
    : 'rgba(255, 255, 255, 0.2)';
    
  const inputBorder = colors.text === '#f8f8f8'
    ? 'rgba(248, 248, 248, 0.3)'
    : 'rgba(0, 0, 0, 0.2)';
    
  const shadowColor = colors.text === '#f8f8f8'
    ? 'rgba(26, 26, 26, 0.5)'
    : 'rgba(0, 0, 0, 0.15)';
  ...
  root.style.setProperty('--adaptive-button-text', '#f8f8f8');
