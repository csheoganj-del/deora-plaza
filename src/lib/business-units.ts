// Multi-Business Unit Management System for BLOOM CAFE
// Manages Cafe & Restaurant operations
      ...
      if (!existingUnits || existingUnits.length === 0) {
        ...
        existingUnits.forEach((dbUnit: any) => {
          ...
          const fullUnit: BusinessUnit = {
            ...
            operatingHours: this.getDefaultOperatingHours(),
            contact: {
              phone: dbUnit.mobile || '+91-9001160228',
              email: 'hello@bloomcafe.com',
              address: dbUnit.address || 'Kesarpura Road, Sheoganj',
              city: 'Sheoganj',
              state: 'Rajasthan',
              pincode: '307027',
