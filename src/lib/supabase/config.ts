...
export function validateClientConfig() {
  ...
  if (!SUPABASE_CONFIG.isClientConfigValid() && !isPlaceholder) {
...
export function validateServerConfig() {
  ...
  if (!SUPABASE_CONFIG.isServerConfigValid() && !isPlaceholder) {
  ...
  if (isPlaceholder) {
    console.warn("⚠️ Using placeholder Supabase credentials. Database operations will fail but app will continue in demo mode.");
  }
}
