    ...
    this.rewards = [
      {
        id: 'reward_1',
        name: 'Free Coffee',
        description: 'Get any coffee of your choice on the house',
        type: 'free_item',
        category: 'beverage',
      ...
      },
      {
        id: 'reward_2',
        name: '10% Off Dining',
        description: 'Get 10% discount on your entire meal',
        type: 'discount',
        category: 'food',
        businessUnits: ['RESTAURANT', 'BAR'],
        requiredPoints: 200,
        value: 10,
        validFrom: '2024-01-01',
        validTo: '2024-12-31',
    ...
    this.customers = [
      {
        ...
        totalSpent: 250,
        visitCount: 5,
        lastVisitDate: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
        enrollmentDate: '2024-01-15',
        preferredBusinessUnits: ['CAFE', 'RESTAURANT'],
        preferences: {
          communication: 'email',
          marketing: true,
          promotions: true,
      ...
      },
      {
        ...
        loyaltyNumber: 'LOY123457',
        currentTier: 'SILVER',
        points: 450,
        lifetimePoints: 800,
        totalSpent: 750,
        visitCount: 12,
        lastVisitDate: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString().split('T')[0],
        enrollmentDate: '2023-11-20',
        preferredBusinessUnits: ['RESTAURANT', 'BAR'],
        preferences: {
          communication: 'both',
          marketing: true,
          promotions: true,
        ...
        achievements: ['achievement_1', 'achievement_2', 'achievement_3'],
        isActive: true,
