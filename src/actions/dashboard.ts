...
export async function getDashboardStats() {
    try {
        ...
        if (isPlaceholder) {
            console.log("[STATS] ⚡ Using mock dashboard stats for demo mode");
            return {
                totalRevenue: 125480,
                pendingRevenue: 12500,
                cafeBarRevenue: 85000,
                bookingsRevenue: 40480,
                revenueByUnit: { cafe: 55000, bar: 30000, garden: 25000, hotel: 15480 },
                transactionCounts: { cafe: 124, bar: 68, garden: 12, hotel: 8 },
                activeOrders: 5,
                activeBookings: 3,
                totalCustomers: 450,
                recentOrders: [
                    { id: 'o1', orderNumber: 'ORD-101', status: 'preparing', createdAt: new Date().toISOString(), tableNumber: '5' },
                    { id: 'o2', orderNumber: 'ORD-102', status: 'ready', createdAt: new Date().toISOString(), tableNumber: '2' },
                    { id: 'o3', orderNumber: 'ORD-103', status: 'pending', createdAt: new Date().toISOString(), roomNumber: '204' },
                ],
                onlineUsersCount: 2,
                devicesOnline: { web: 2, android: 0, ios: 0 },
                recentLogins: [],
                usersOnline: [],
                usersOffline: []
            };
