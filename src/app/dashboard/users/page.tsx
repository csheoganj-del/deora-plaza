      ...
      <div className="apple-glass-card">
        <div className="p-8 border-b border-[#E5E7EB]">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <h2 className="apple-text-heading">Users ({filteredUsers.length})</h2>
            <Button onClick={handleAddUser} className="apple-button-primary">
        ...
        <div className="p-8">
          ...
          {selectedUsers.size > 0 && (
            <div className="mb-4 p-3 bg-[#EDEBFF]/20 border border-[#EDEBFF]/30 rounded-lg flex items-center justify-between">
              ...
              <Button
                className="apple-interactive bg-[#EF4444] hover:bg-[#DC2626]"
                  ...
                  {filteredUsers.map((user) => (
                    <TableRow key={user.id}>
                      ...
                      <TableCell className="text-right space-x-2">
                        <Button
                          className="apple-interactive h-8 w-8 text-[#6D5DFB] hover:text-[#6D5DFB] hover:bg-[#EDEBFF]/20"
                          variant="ghost"
                          size="icon"
                        ...
                        <Button
                          className={`apple-interactive h-8 w-8 ${user.isActive
                        ...
                        <Button
                          className="apple-interactive h-8 w-8 text-[#EF4444] hover:text-[#DC2626] hover:bg-[#FEE2E2]"
                          variant="ghost"
                          size="icon"
