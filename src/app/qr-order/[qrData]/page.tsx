...
export default function QROrderPage({ params }: { params: Promise<{ qrData: string }> }) {
  ...
  useEffect(() => {
    const validateQRCode = () => {
      try {
        const decodedData = qrCodeManager.decodeQRData(resolvedParams.qrData);
        if (!decodedData) {
